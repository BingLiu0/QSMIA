...
def get_args_parser():
    ...
    parser.add_argument("--model", default="resnet50", type=str,
                        choices=['resnet50', 'vgg16', 'vgg19', 'wide_resnet50_2', 'mobilenetv2_100', 'vit_base_patch16_224'])
...
def quantization_similarity(args, path, w_bits, a_bits, target_model, distill_target_model, shadow_model, distill_shadow_model, 
    ...
    q_distill_target_model.to(args.device)
    ...
    q_distill_shadow_model.to(args.device)
...
def main():
    ...
    # target_model.load_state_dict(torch.load("./saved_models/mobilenetv2_100_CINIC10_2025_03_11_18_39_47/target_model.pth", weights_only=True))
    ...
    # distill_target_model.load_state_dict(torch.load("./saved_models/mobilenetv2_100_CINIC10_2025_03_11_18_39_47/distill_target_model.pth", weights_only=True))
    ...
    # shadow_model.load_state_dict(torch.load("./saved_models/mobilenetv2_100_CINIC10_2025_03_11_18_39_47/shadow_model.pth", weights_only=True))
    ...
    # distill_shadow_model.load_state_dict(torch.load("./saved_models/mobilenetv2_100_CINIC10_2025_03_11_18_39_47/distill_shadow_model.pth", weights_only=True))
    ...
    for w_bits, a_bits in quantization_configs:
        target_train_sim, target_test_sim, shadow_train_sim, shadow_test_sim = quantization_similarity(args, path, w_bits, a_bits, target_model, distill_target_model, shadow_model, distill_shadow_model, 
                                                                                                    dataloaders_target, dataloaders_shadow, distill_calib_data)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser('QS-MIA', parents=[get_args_parser()])
